                ...
                <form method="post">
                    ...
                    <div class="left-side">
                        <div class="header-details">
                            <h3>Watch YT Age Restricted Videos</h3>
                            <div class="intro-banner-search-form margin-top-95 mb-5">
                                ...
                                <div class="intro-search-button">
                                    <button class="button ripple-effect" name="submit" id="ar_btn" type="button">Show Video</button>
                                </div>
                            </div>
                            <span class="notes">Example : https://www.youtube.com/watch?v=m6VXpTIrIAk</span>
                        </div>
                    </div>
                </div>
                </form>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
            ...
            <div class="listings-container  compact-list-layout  mb-5" id="ar_results">
                <div class="videoWrapper d-none">
                     <!--iframe results display here=-->   
                </div>
            </div>
