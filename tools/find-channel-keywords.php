                ...
                <form method="post">
                    ...
                    <div class="left-side">
                        <div class="header-details">
                            <h3>YT Find Channel Keywords</h3>
                            <div class="intro-banner-search-form margin-top-95 mb-5">
                                ...
                                <div class="intro-search-field with-autocomplete">
                                    ...
                                    <div class="input-with-icon">
                                        <input id="autocomplete-input" type="url" required name="video_tags" placeholder="Please enter channel url here">
                                        <i class="icon-brand-youtube"></i>
                                    </div>
                                </div>
                                <!-- Button -->
                                <div class="intro-search-button">
                                    <button class="button ripple-effect" name="submit" type="submit">Find Keywords</button>
                                </div>
                            </div>
    ...
    <div class="row">
        ...
        <?php
           if(isset($_POST['submit']))
           {
               ...
               if($search !== false)
                {
                    $result = getChannelKeyWord($search);
                    $result = $result['keywords'][0];
                    $tagcount = count($result);
                }   
        ?>
            <div class="single-page-section">
                <h3 class="margin-bottom-25">Channel Keywords</h3>
                <!-- Listings Container -->
            ...
            <?php } ?>
            <div class="single-page-section">
                <h3 class="margin-bottom-25">About YT Channel Keywords Finder Tool</h3>
                <?php echo $pcontent; ?>
            </div>
        </div>
