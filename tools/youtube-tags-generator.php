                        ...
                        <div class="header-details">
                            ...
                            <div class="intro-banner-search-form margin-top-95 mb-5">
                                ...
                                <div class="intro-search-button">
                                    <button class="button ripple-effect" name="submit" type="submit"> <span>Generate Tags</span></button>
                                </div>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-8 content-right-offset">
            <?php
                ...
                {
                    $search = trim($_POST['tags']);
                    $result = getTags($search);
            ...
            <?php } ?>
            <div class="single-page-section">
                <h3 class="margin-bottom-25">About YT Tags Generator</h3>
                <?php echo $pcontent; ?>
            </div>
        </div>
        <!-- ./ card [main form] -->
